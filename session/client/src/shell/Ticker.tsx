...
export function Ticker() {
  ...
  return (
    <button
      ...
      className="absolute bottom-9 left-2.5 flex h-[26px] max-w-[480px] items-center gap-2 truncate rounded-md border border-border-default bg-surface-1/90 px-2.5 text-xs text-text-secondary transition-colors duration-150 ease-out-quart hover:bg-surface-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-border-focus motion-reduce:transition-none"
    >
